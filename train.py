...
def train(opt):
    ...
    while(True):
        ...
        if (iteration + 1) % 1e+5 == 0:
            ...
            torch.save(
                model, f'./saved_models/{opt.exp_name}/iter_{iteration+1}_.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='0513', help='Where to store logs and models')
    ...
    parser.add_argument('--FeatureExtraction', default='ResNet', type=str, required=True,
